    ...
    "helpers": [
        {
            ...
            "label": "PV1-FIAE",
            "db_path": str(ROOT / "data" / "Kurse" / "Pruefungsvorbereitung-1-FIAE-Quiz.db"),
            "target_questions": 1000,
        },
        {
            "agent_id": "019d2d52-0289-7062-b1b7-ad2a3875faf4",
            "label": "QuS2",
            "db_path": str(ROOT / "data" / "Kurse" / "QuS2-Quiz.db"),
            "target_questions": 1000,
        },
        {
            "agent_id": "019d2d4f-2784-7b02-b53c-c42dd22f37c9",
            "label": "LF12FIAE",
            "db_path": str(ROOT / "data" / "Kurse" / "LF12FIAE-Quiz.db"),
            "target_questions": 1000,
        },
        {
            "agent_id": "019d2d53-cd05-7350-9285-feee343bfd42",
            "label": "PV3-WISO",
            "db_path": str(ROOT / "data" / "Kurse" / "Pruefungsvorbereitung-3-WISO-Quiz.db"),
            "target_questions": 1000,
        },
    ],
}
