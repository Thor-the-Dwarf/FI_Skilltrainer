...
function flattenSelection12HierarchyItems(metadata = {}) {
...
export function getSelection12DetailItems({
  metadata,
  selectionId,
  selectionTitle,
  faceEntries,
  ...
  if (metadata?.crystalRuneEntry) {
    return flattenSelection12HierarchyItems(metadata);
  }
  ...
  return buildSelectionPlaceholderDetailItems({
    ...
    selectionTitle,
    faceEntries,
    familyLabel: familyLabel || placeholderProfile.familyLabel || "dodecahedral",
...
export function getSelection12VaultLodConfig() {
  return {
    enterDistance: 11.1,
    exitDistance: 12.3
  };
