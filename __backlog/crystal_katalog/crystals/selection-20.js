...
function flattenSelection20HierarchyItems(metadata = {}) {
...
export function getSelection20DetailItems({
  metadata,
  selectionId,
  selectionTitle,
  faceEntries,
  ...
  if (metadata?.crystalRuneEntry) {
    return flattenSelection20HierarchyItems(metadata);
  }
  ...
  return buildSelectionPlaceholderDetailItems({
    ...
    selectionTitle,
    faceEntries,
    familyLabel: familyLabel || placeholderProfile.familyLabel || "icosahedral",
...
export function getSelection20VaultLodConfig() {
  return {
    enterDistance: 11.4,
    exitDistance: 12.7
  };
