...
function flattenSelection11HierarchyItems(metadata = {}) {
...
export function getSelection11DetailItems({
  metadata,
  selectionId,
  selectionTitle,
  faceEntries,
  ...
  if (metadata?.crystalRuneEntry) {
    return flattenSelection11HierarchyItems(metadata);
  }
  ...
  return buildSelectionPlaceholderDetailItems({
    ...
    selectionTitle,
    faceEntries,
    familyLabel: familyLabel || placeholderProfile.familyLabel || "corner-cut-bipyramidal",
...
export function getSelection11VaultLodConfig() {
  return {
    enterDistance: 10.9,
    exitDistance: 12.1
  };
